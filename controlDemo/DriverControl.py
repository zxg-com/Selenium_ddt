...
import driver.BaseFunc as Base
from appium import webdriver as driver2
from appium.webdriver.common.touch_action import TouchAction
import subprocess,sys,time,os
import setting.Setting_General as info
...
Base.Func_suite.delfile(Base,os.path.abspath(".")+"/log/")
Base.Func_suite.delfile(Base,os.path.abspath(".")+"/report/Cache")
Base.Func_suite.delfile(Base,os.path.abspath(".")+"/report/img")
